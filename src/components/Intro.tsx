...
const questions = [
  ...
  {
    number: '03',
    title: 'Не хотите тратить время на дизайн?',
    text: 'Просто ответьте на вопросы. Идеальный медиакит сгенерируется автоматически, избавляя вас от ручной вёрстки.',
  },
]
      ...
      <section className="intro__hero">
        <div className="intro__hero-content">
          ...
          <p className="intro__lead">
            Заполните простую анкету и получите готовый PDF из четырёх слайдов — без ручной вёрстки и навыков дизайна.
          </p>
